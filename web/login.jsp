...
<head>
    ...
    <title>Sadra's Auction System | Login</title>
    ...
    <div class="header">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a class="active" href="#">Login</a>me</li>
...
<div class="quickreg">
    <div class="quickreg-input">
        ...
        <form action="verify.jsp" method="post">
            ...
            <br>
            <input type="submit" class="Button" name="act" value="Login"/>
        </form>
        <%}else{%>
        <form action="verify.jsp" method="get">
